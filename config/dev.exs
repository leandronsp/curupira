...
config :curupira, CurupiraWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "52npp8yHcAReb3gEgdWSe2aFHgimMacTypvIyiq/DL/INOVZ6Hr8tMyenRoF7fUZ",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:curupira, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:curupira, ~w(--watch)]}
  ]
...
config :curupira, CurupiraWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/curupira_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :curupira, dev_routes: true
