    ...
    <body class="min-h-screen bg-base-100">
      ...
      <header class="sticky top-0 z-50 bg-base-100 border-b border-base-300 shadow-sm">
        ...
        <div class="border-t border-base-300">
          <div class="container mx-auto px-4 sm:px-6 max-w-6xl">
            <div class="py-3">
              <a href="/" onclick="event.preventDefault(); history.back();" class="inline-flex items-center gap-2 px-4 py-1.5 text-sm font-medium rounded-full transition-all whitespace-nowrap bg-base-100 hover:bg-base-300 text-base-content border border-base-300 cursor-pointer">
