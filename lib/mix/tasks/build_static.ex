      ...
      <header class="sticky top-0 z-50 bg-base-100 border-b border-base-300 shadow-sm">
        <div class="container mx-auto px-4 sm:px-6 py-4 max-w-6xl">
          <div class="flex items-center justify-between gap-4 mb-4">
            <h1 class="text-2xl sm:text-3xl font-bold text-base-content">#{profile.name || "Blog"}</h1>
            <div class="flex items-center gap-3">
              <a href="https://web101.leandronsp.com" target="_blank" rel="noopener noreferrer" class="text-sm text-base-content/60 hover:text-primary transition-colors cursor-pointer">web101</a>
              <a href="https://concorrencia101.leandronsp.com" target="_blank" rel="noopener noreferrer" class="text-sm text-base-content/60 hover:text-primary transition-colors cursor-pointer">concorrencia101</a>
              <a href="https://aws101.leandronsp.com" target="_blank" rel="noopener noreferrer" class="text-sm text-base-content/60 hover:text-primary transition-colors cursor-pointer">aws101</a>
