          ...
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-2 lg:gap-4 mb-4">
            ...
            <div class="flex flex-col items-end gap-2 flex-shrink-0">
              ...
              <div class="flex gap-2">
                <button class="lang-filter-btn px-3 py-1 text-xs font-medium rounded-full transition-all whitespace-nowrap bg-primary text-white cursor-pointer" data-lang="all" onclick="window.blogFilters.setLanguage('all')">All</button>
                <button class="lang-filter-btn px-3 py-1 text-xs font-medium rounded-full transition-all whitespace-nowrap bg-transparent hover:bg-base-200 text-base-content cursor-pointer" data-lang="pt" onclick="window.blogFilters.setLanguage('pt')">🇧🇷 PT</button>
                <button class="lang-filter-btn px-3 py-1 text-xs font-medium rounded-full transition-all whitespace-nowrap bg-transparent hover:bg-base-200 text-base-content cursor-pointer" data-lang="en" onclick="window.blogFilters.setLanguage('en')">🇺🇸 EN</button>
              </div>
            </div>
          </div>
